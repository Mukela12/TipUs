...
export default function QRCodesPage() {
  ...
  }, [venue?.id, fetchQRCodes, fetchEmployees])
    ...
    <div>
      ...
      >
        <div>
          ...
          <p className="mt-0.5 text-sm text-surface-500">
            Create and manage QR codes for your venue.
          </p>
        </div>
        <button
      ...
      {qrCodes.length === 0 && (
        ...
        >
          ...
          <h3 className="text-base font-semibold text-surface-900">No QR codes yet</h3>
          <p className="mt-1 text-sm text-surface-500">
            Create your first QR code to start accepting tips.
          </p>
          {!showForm && (
            <button
